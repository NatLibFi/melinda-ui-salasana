...
export function handleFailedRouteParams(req, res, next) {
  ...
  const failedParams = [...checkSalasanaRouteParams(routeParams)]
  ...
  //-----------------------------------------------------------------------------
  // Checks Salasanaapp specific route parameters
  //  - possible Salasana route parameters are: 
  //  - all parameters are not present in every request
  //
  function checkSalasanaRouteParams(routeParams) {
    return [];
  }
